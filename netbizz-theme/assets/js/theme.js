/*
================================================================
* Template:  	 NetBizz - One Page Documentation HTML Template
* Written by: 	 Netizens Technologies - (http://netizenstechnologies.com)
...
$('#sidebarCollapse').on('click', function () {
	...
	$('.NetBizz-navigation').toggleClass('active');
});
...
$('.smooth-scroll,.NetBizz-navigation a').on('click', function() {
